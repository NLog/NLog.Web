...
{
    public class AspNetResponseTrailersLayoutRendererTests : LayoutRenderersTestBase<AspNetResponseTrailersLayoutRenderer>
    {
        [Fact]
        ...
        private static AspNetResponseTrailersLayoutRenderer CreateRenderer(bool addSecondHeader = true)
        {
            ...
            responseTrailerFeature.Trailers.Returns(trailers);
